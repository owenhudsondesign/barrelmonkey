...
// Supabase Database type — auto-generated from remote schema
// Regenerate with: npx supabase gen types typescript --project-id hkqhssjbijzmjrqxxirq > lib/types/supabase.ts
