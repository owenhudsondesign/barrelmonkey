      ...
      <div className="flex items-start justify-between mb-8 gap-4">
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-sm text-white/70 hover:text-white border border-white/10 hover:border-white/20 px-3 py-1.5 rounded-md transition-colors"
          >
          ...
          <RowActions
            editHref={`/transfers/${id}/edit`}
            onDelete={deleteTibRecord.bind(null, id)}
