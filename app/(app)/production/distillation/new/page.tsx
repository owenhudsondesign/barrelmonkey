...
import { DistillationRunForm } from '@/components/production/distillation-run-form'

export const metadata = {
  title: 'New Distillation Run — BarrelMonkey',
}
...
export default function NewDistillationPage() {
  return (
    <div className="max-w-2xl">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white">New Distillation Run</h1>
        <p className="text-sm text-white/40 mt-1">
          Log a new distillation run
        </p>
      </div>
